...
<template>
  <div
      :class=" `hidden h-[${leftContentHeight}px]  xl:w-4/12 2xl:block p-2`"
  >

    <div
        class="w-full h-auto sticky top-24  mb-5"
    >
      <div
        ...
        >
          ...
          >
            <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                class="w-10 h-10  ease-in-out hover:scale-125 hover:fill-indigo-800  duration-300"
            >
              <path
